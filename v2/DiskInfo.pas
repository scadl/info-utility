...
sLabelFX1.Caption:='—вободно на '+UpCase(DriveComboBox1.Drive)+':\ '+inttostr(DiskFree( ord(DriveComboBox1.Drive)-96 )div 1024 div 1024)+' ћб';
...
if DiskFree( ord(DriveComboBox1.Drive)-96 )=0 then sLabelFX1.Caption:=UpCase(DriveComboBox1.Drive)+':\ - это CD или DVD.';
if DiskFree( ord(DriveComboBox1.Drive)-96 )=-1 then sLabelFX1.Caption:='”стройство '+UpCase(DriveComboBox1.Drive)+':\ - пустое!';
