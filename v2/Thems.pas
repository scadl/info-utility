...
begin
form1.sSkinManager1.SkinName:='Office2010 Blue (internal)';
form1.Memo1.Lines[7]:='Office2010 Blue (internal)';
form1.TrayIcon1.BalloonHint:='义爨: '+form1.Memo1.Lines[7];
end;

procedure TFrame123.sSpeedButton7Click(Sender: TObject);
begin
form1.sSkinManager1.SkinName:='WLM (internal)';
form1.Memo1.Lines[7]:='WLM (internal)';
form1.TrayIcon1.BalloonHint:='义爨: '+form1.Memo1.Lines[7];
end;
